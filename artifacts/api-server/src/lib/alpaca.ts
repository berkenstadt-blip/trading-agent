...
const ALPACA_KEY    = process.env.ALPACA_API_KEY    ?? "PKWTTMQ6MMNG4D4JKAUXGAMDRD";
const ALPACA_SECRET = process.env.ALPACA_SECRET_KEY ?? "4q2fWdtbQxui1Fi7q5piFfhFbwScVcjQmxJuNEy71Vz8";
